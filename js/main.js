...
function horoscope() {
	...
	var zodiacInput = document.getElementById("zodiacInput").value;
	var signName = document.getElementById("signName");
	var signImage = document.getElementById("signImage");
	var signDescription = document.getElementById("signDescription");

	for(var i = 0; i < zodiacSigns.length; i++) {

		if(zodiacInput.toLowerCase() === zodiacSigns[i].sign) {

			signName.innerText = zodiacSigns[i].sign;
			signName.style.color = "black";
			signImage.src = zodiacSigns[i].picture;
			signDescription.innerText = zodiacSigns[i].description;
			document.getElementById("results").style.backgroundColor = "rgba(255,255,255,0.5)";
			...
			signName.textContent = "Sign Not Found. Try Again!";
			signName.style.color = "red";
			signImage.src = "";
			signDescription.innerText = "";
